...
public class UserPhoneToken implements HostAuthenticationToken, RememberMeAuthenticationToken {
    ...
    public UserPhoneToken(final String username, final char[] password) {
    ...
    public UserPhoneToken(final String username, final char[] password, final String host) {
        this(username, password, false, host);
    }


    public UserPhoneToken(final String username, final String password, final String host) {
        this(username, password != null ? password.toCharArray() : null, false, host);
    }


    public UserPhoneToken(final String username, final char[] password, final boolean rememberMe) {
        this(username, password, rememberMe, null);
    }


    public UserPhoneToken(final String username, final String password, final boolean rememberMe) {
